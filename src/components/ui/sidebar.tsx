...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-0 overflow-y-auto scroll-smooth overscroll-contain group-data-[state=collapsed]:group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
